...
const What_I_Do = ({ icon, title, description }) => {
    return (
        <div className='w-[215px] sm:w-[260px] md:w-[280px] h-[280px] sm:h-[300px] mx-auto rounded-xl bg-white shadow-lg flex flex-col items-center justify-center p-5 transform transition-transform duration-300 hover:scale-105'>
